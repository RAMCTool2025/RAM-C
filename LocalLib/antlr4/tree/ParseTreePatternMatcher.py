...
from LocalLib.antlr4.ListTokenSource import ListTokenSource
from LocalLib.antlr4.Token import Token
from LocalLib.antlr4.error.ErrorStrategy import BailErrorStrategy
from LocalLib.antlr4.error.Errors import RecognitionException, ParseCancellationException
from LocalLib.antlr4.tree.Chunk import TagChunk, TextChunk
from LocalLib.antlr4.tree.RuleTagToken import RuleTagToken
from LocalLib.antlr4.tree.TokenTagToken import TokenTagToken
from LocalLib.antlr4.tree.Tree import ParseTree, TerminalNode, RuleNode
...
class ParseTreePatternMatcher(object):
    ...
    def matchPattern(self, tree:ParseTree, pattern:ParseTreePattern):
        ...
        from LocalLib.antlr4.tree.ParseTreeMatch import ParseTreeMatch
    ...
    def compileTreePattern(self, pattern:str, patternRuleIndex:int):
        ...
        from LocalLib.antlr4.ParserInterpreter import ParserInterpreter
        ...
        from LocalLib.antlr4.tree.ParseTreePattern import ParseTreePattern
