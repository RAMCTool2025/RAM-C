...
from LocalLib.antlr4.CommonTokenFactory import CommonTokenFactory
...
from LocalLib.antlr4.error.Errors import IllegalStateException, LexerNoViableAltException, RecognitionException
