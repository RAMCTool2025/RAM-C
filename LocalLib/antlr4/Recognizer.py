...
from LocalLib.antlr4.error.ErrorListener import ProxyErrorListener, ConsoleErrorListener
...
class Recognizer(object):
    ...
    def getTokenTypeMap(self):
        ...
        if tokenNames is None:
            from LocalLib.antlr4.error.Errors import UnsupportedOperationException
